...
final class ACContainerTests: XCTestCase {
        ...
        func testAdaptiveCardDecoding() throws {
            ...
            let adaptiveCard = try decoder.decode(AdaptiveCard.self, from: json)
