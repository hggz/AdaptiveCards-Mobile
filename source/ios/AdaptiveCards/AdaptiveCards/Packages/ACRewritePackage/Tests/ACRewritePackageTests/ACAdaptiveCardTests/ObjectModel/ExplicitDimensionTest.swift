...
class ExplicitDimensionForColumnTest: XCTestCase {
    ...
    func testExplicitWidthMalformedUnitTest() {
        ...
        XCTAssertEqual(column.pixelWidth, 0)
        XCTAssertEqual(column.width, "20px20")
    }
    
    func testExplicitWidthMalformedValueTest() {
        let testJsonString = """
        {
          "$schema": "http://adaptivecards.io/schemas/adaptive-card.json",
          "type": "AdaptiveCard",
    ...
    func testExplicitWidthFloatValueTest() {
        let testJsonString = """
        {
          "$schema": "http://adaptivecards.io/schemas/adaptive-card.json",
          "type": "AdaptiveCard",
        ...
        XCTAssertEqual(column.width, "20.5px")
