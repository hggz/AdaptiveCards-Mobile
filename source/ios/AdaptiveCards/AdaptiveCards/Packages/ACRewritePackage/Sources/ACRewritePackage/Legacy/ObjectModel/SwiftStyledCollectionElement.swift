...
class SwiftStyledCollectionElement: SwiftBaseCardElement {
    ...
    override func encode(to encoder: Encoder) throws {
        ...
        if style != .none {
            try container.encode(SwiftContainerStyle.toString(style), forKey: .style)  // Use toString
        }
    ...
    func serializeToJsonV() throws -> [String: Any] {
        ...
        if style != .none {
            json["style"] = SwiftContainerStyle.toString(style)  // Use toString instead of rawValue
        }
