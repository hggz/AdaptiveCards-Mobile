...
protocol SwiftACMarkDownParserProtocol {
...
class SwiftACMarkDownParser: SwiftACMarkDownParserProtocol {
    private var m_text: String
    private var m_parsedResult: SwiftACMarkDownParsedResult
    private var m_hasHTMLTag: Bool
    private var m_isEscaped: Bool

    required init(txt: String) {
        self.m_text = txt
        self.m_parsedResult = SwiftACMarkDownParsedResult()
    ...
    private func parseBlock() {
        ...
        let parser = SwiftACEmphasisParser()
