...
//    @Published var adaptiveCard: AdaptiveCard
//    
//    init(adaptiveCard: AdaptiveCard) {
//        self.adaptiveCard = adaptiveCard
//    }
//}

//@main
//struct AdaptiveCardApp: App {
//    var body: some Scene {
//        WindowGroup {
//            if let card = loadAdaptiveCard() {
//                AdaptiveCardView(viewModel: AdaptiveCardViewModel(adaptiveCard: card))
//            } else {
