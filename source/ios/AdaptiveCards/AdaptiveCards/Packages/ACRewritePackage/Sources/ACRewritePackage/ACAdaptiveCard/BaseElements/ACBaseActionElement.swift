...
class SwiftACBaseActionElement: SwiftACBaseElement {
    var title: String?
    var iconUrl: String?
    var style: String?
    var tooltip: String?
    var isEnabled: Bool?
    var type: SwiftACActionType?
    var mode: SwiftACMode?
    var role: SwiftACActionRole?
    ...
    required init(from decoder: Decoder) throws {
        ...
        self.type = try container.decodeIfPresent(SwiftACActionType.self, forKey: .type)
        self.mode = try container.decodeIfPresent(SwiftACMode.self, forKey: .mode)
        self.role = try container.decodeIfPresent(SwiftACActionRole.self, forKey: .role)
        super.init()
    }
